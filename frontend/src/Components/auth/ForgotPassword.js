...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post("/api/forgotpassword", { email: email.trim().toLowerCase() });
    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        <div style={styles.sideCard}>
          <p style={styles.eyebrow}>Recover Access</p>
          <h2 style={styles.sideTitle}>Reset your password securely.</h2>
          <p style={styles.sideText}>
            Enter your registered email to receive a one-time code. Use only your own inbox and do not share OTP with anyone.
          </p>
          <div style={styles.sideNote}>Tip: check spam/junk folder if the OTP email is delayed.</div>
        </div>
